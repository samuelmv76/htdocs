...
<body>
  ...
  <div class="container mt-4">
    <h1 class="text-center mb-3" style="font-size: 1.5rem;">Registro de Glucosa</h1>
    <form action="submit_controlglucosa.php" method="POST" class="needs-validation" novalidate>
      ...
      <div class="form-group">
        <label for="deporte" class="form-label">Índice de actividad (1 sedentario - 5 muy activo):</label>
