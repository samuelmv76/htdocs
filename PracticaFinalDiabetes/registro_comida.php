  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link" href="registro_controlglucosa.php"
              >Registro Control de glucosa (1 DIARIO)</a
            >
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="registro_comida.php"
              >Registro Comida (Hasta 5 diarios)</a
            >
          </li>
          <li class="nav-item">
    ...
    <form action="submit_comida.php" method="POST" class="needs-validation" novalidate>
      ...
      <div class="form-group">
        <label for="tipo_comida" class="form-label"
          >Tipo de Comida (Desayuno/Comida/Cena):</label
        >
        <input
          type="text"
          id="tipo_comida"
      ...
      <div class="form-group">
        ...
        <label for="chk_hiper" class="form-check-label"
          >Registrar Hiperglucemia</label
        >
      </div>
      ...
      <div class="form-group">
        ...
        <label for="chk_hipo" class="form-check-label"
          >Registrar Hipoglucemia</label
        >
      </div>
      <div id="hipoglucemia" class="hidden">
        ...
        <div class="form-group">
          <label for="recuperacion" class="form-label"
            >Recuperación (g de carbohidratos):</label
          >
          <input
            type="number"
            id="recuperacion"
